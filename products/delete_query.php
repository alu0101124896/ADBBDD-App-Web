...
<body>
  ...
  $query = "UPDATE producto SET deleted = 1
              WHERE id LIKE '" . $_GET['id'] . "';";

  mysqli_query($db, $query) or die('Error al eliminar');

  echo '<h1>Eliminación realizada con éxito.</h1>';
